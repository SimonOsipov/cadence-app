...
sealed interface SessionState {
     ...
     *
     * Not an edge case: a patient **holding** a session sits here for one network round trip on
     * any cold start past the vendor's refresh threshold — the last fifth of GoTrue's 3600s
     * token, so more than ~48 minutes after it was issued. What ends this state on each platform
     * is measured in the step-1 deviation of `docs/specs/mobile-sign-in.md`.
     */
