// Curated Heroicons subset (MIT, https://heroicons.com)
// Copy of outline 24/24 paths. Use: <Icon name="plus" size={20} />
// All icons render at 24x24 viewBox, stroke="currentColor", stroke-width 1.5.
...
const HEROICONS = {
  ...
  'fire':            '<path stroke-linecap="round" stroke-linejoin="round" d="M15.362 5.214A8.252 8.252 0 0 1 12 21 8.25 8.25 0 0 1 6.038 7.047 8.287 8.287 0 0 0 9 9.601a8.983 8.983 0 0 1 3.361-6.867 8.21 8.21 0 0 0 3 4.48Z"/><path stroke-linecap="round" stroke-linejoin="round" d="M12 18a3.75 3.75 0 0 0 .495-7.467 5.99 5.99 0 0 0-1.925 3.546 5.974 5.974 0 0 1-2.133-1.001A3.75 3.75 0 0 0 12 18Z"/>',
  'bolt':            '<path stroke-linecap="round" stroke-linejoin="round" d="M3.75 13.5 13.5 3l-3 7.5h7.5L7.5 21l3-7.5h-7.5Z"/>',
  ...
  'cake':            '<path stroke-linecap="round" stroke-linejoin="round" d="M15 11.25v3.75m-7.5-3.75v3.75M12 11.25v3.75M3.75 21h16.5M3 8.25l9-5.25 9 5.25M3 21V8.25h18V21M3.75 8.25h16.5"/>',
...
window.Icon = function Icon({ name, size = 20, color = 'currentColor', className = '', style = {}, strokeWidth = 1.5 }) {
  const path = HEROICONS[name];
  if (!path) {
    return React.createElement('span', {
      style: { display:'inline-block', width:size, height:size, border:'1px dashed #c00', borderRadius:2, ...style },
